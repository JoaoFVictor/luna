...
import instructions from "../../agents/acceptance-reviewer/instructions.md" with { type: "markdown" };
...
const agentId = "acceptance-reviewer";

export const description =
  "Decides whether reviewed changes satisfy the claimed pull request intent without blocking on nonessential issues.";
...
async function loadAgentConfig() {
  const content = await readFile(
    new URL("../../agents/acceptance-reviewer/agent.yaml", import.meta.url),
    "utf8"
  );
