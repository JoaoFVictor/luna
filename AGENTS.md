...
- `src/tools/`: local tools exposed to agents.
...
- `skills/luna-create-tool/SKILL.md`: create local Flue tools.
...
- Register local tools through `src/core/flue-tool-registry.ts`.
